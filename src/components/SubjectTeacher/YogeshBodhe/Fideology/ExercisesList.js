...
import Exercises from '../../../../api/YogeshBodhe/Exercise';
...
const Exercise = props => (
    <tr>
        ...
        <td>
            <Link to={"/subject-teacher/yogesh-bodhe/edit/"+props.exercise._id}><i className='bx bx-edit-alt'></i></Link> | <span onClick={() => {props.deleteExercise(props.exercise._id) }} ><i className='bx bx-trash'></i></span>
    ...
    render() { 
        return ( 
            ...
            <div className="fideo">
                ...
                <Link to={'/subject-teacher/yogesh-bodhe/fideology-form'}><div className='add'>Add</div></Link>
            </div>
            </div>
         );
    }
