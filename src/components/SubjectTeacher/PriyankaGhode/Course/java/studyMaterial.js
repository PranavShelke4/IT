...
import Studymaterials from '../../../../../api/GhodeMadam/JavaStudymaterial';
    ...
    render() { 
        return ( 
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/drive/folders/1Pd26y8X9VEK0LJYSULTA7ZULsaOnVPsd?usp=sharing"><div className='add-files'>Files</div></a>
                ...
                <Link to={'/subject-teacher/priyanka-ghode/java/add-studymaterial'}><div className='add'>Add</div></Link>
            </div>
            </div>
         );
    }
