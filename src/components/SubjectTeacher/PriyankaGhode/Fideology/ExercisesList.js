...
import Exercises from '../../../../api/GhodeMadam/Exercise';
...
const Exercise = props => (
    <tr>
        ...
        <td>
            <Link to={"/subject-teacher/priyanka-ghode/edit/"+props.exercise._id}><i className='bx bx-edit-alt'></i></Link> | <span onClick={() => {props.deleteExercise(props.exercise._id) }} ><i className='bx bx-trash'></i></span>
    ...
    render() { 
        return ( 
            ...
            <div className="fideo">
                ...
                <Link to={'/subject-teacher/priyanka-ghode/fideology-form'}><div className='add'>Add</div></Link>
            </div>
            </div>
         );
    }
