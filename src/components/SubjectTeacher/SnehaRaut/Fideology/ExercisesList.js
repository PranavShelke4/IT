...
import Exercises from '../../../../api/RautMadam/Exercise';
...
const Exercise = props => (
    <tr>
        ...
        <td>
            <Link to={"/subject-teacher/sneha-raut/edit/"+props.exercise._id}><i className='bx bx-edit-alt'></i></Link> | <span onClick={() => {props.deleteExercise(props.exercise._id) }} ><i className='bx bx-trash'></i></span>
