    ...
    <div>
      <div className="sidebar close">
        ...
        <ul className="nav-links">
          <li>
            <Link to="/subject-teacher/poonam-fafat/dashboard">
              <i className="bx bx-home-alt"></i>
              <span className="link_name">Dashboard</span>
            </Link>
            <ul className="sub-menu blank">
              <li>
                <Link className="link_name" to="/subject-teacher/poonam-fafat/dashboard">
                  Dashboard
                </Link>
              </li>
            </ul>
          ...
          <li>
            ...
            <ul className="sub-menu">
              ...
              <li>
                <Link to="/subject-teacher/poonam-fafat/student-details">First Year</Link>
              </li>
              <li>
                <Link to="/subject-teacher/poonam-fafat/student-details">Second Year</Link>
              </li>
              <li>
                <Link to="/subject-teacher/poonam-fafat/student-details">Third Year</Link>
              </li>
            </ul>
          </li>

          <li>
            <Link to="/subject-teacher/poonam-fafat/course">
              <i className="bx bx-book"></i>
              <span className="link_name">Course</span>
            </Link>
            <ul className="sub-menu blank">
              <li>
                <Link className="link_name" to="/subject-teacher/poonam-fafat/course">
                Course
                </Link>
              </li>
            </ul>
          ...
          <li>
            ...
            <ul className="sub-menu">
              ...
              <li>
                <Link to="/subject-teacher/poonam-fafat/profile">Profile</Link>
              </li>
            </ul>
          </li>

          <li>
            <Link to="/subject-teacher/poonam-fafat/leave">
              <i className="bx bxs-comment-detail"></i>
              <span className="link_name">Leaves</span>
            </Link>
            <ul className="sub-menu blank">
              <li>
                <Link className="link_name" to="/subject-teacher/poonam-fafat/leave">
                Leaves
                </Link>
              </li>
            </ul>
