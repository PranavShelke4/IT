...
import Exercises from '../../../../api/JyotiDabhade/Exercise';
...
const Exercise = props => (
    <tr>
        ...
        <td>
            <Link to={"/subject-teacher/jyoti-dabhade/edit/"+props.exercise._id}><i className='bx bx-edit-alt'></i></Link> | <span onClick={() => {props.deleteExercise(props.exercise._id) }} ><i className='bx bx-trash'></i></span>
    ...
    render() { 
        return ( 
            ...
            <div className="fideo">
                ...
                <Link to={'/subject-teacher/jyoti-dabhade/fideology-form'}><div className='add'>Add</div></Link>
            </div>
            </div>
         );
    }
