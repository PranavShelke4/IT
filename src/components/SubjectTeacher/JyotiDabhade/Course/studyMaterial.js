...
import Studymaterials from '../../../../api/JyotiDabhade/Studymaterial';
...
const Studymaterial = props => (
    <tr>
        ...
        <td>
            <Link to={"/subject-teacher/jyoti-dabhade/studymaterial/edit/"+props.studymaterial._id}><i className='bx bx-edit-alt'></i></Link> | <span onClick={() => {props.deleteStudymaterial(props.studymaterial._id) }} ><i className='bx bx-trash'></i></span>
    ...
    render() { 
        return ( 
            ...
            <div className="fideo">
                ...
                <Link to={'/subject-teacher/jyoti-dabhade/add-studymaterial'}><div className='add'>Add</div></Link>
            </div>
            </div>
         );
    }
