...
import "./DabhdeSubNavbar.css";
import {Link} from 'react-router-dom';
import DabhadeMImg from "../../../assets/img/dabhade_madam.jpg"
    ...
    <div>
      <div className="sidebar close">
        ...
        <ul className="nav-links">
          <li>
            <Link to="/subject-teacher/jyoti-dabhade/dashboard">
              <i className="bx bx-home-alt"></i>
              <span className="link_name">Dashboard</span>
            </Link>
            <ul className="sub-menu blank">
              <li>
                <Link className="link_name" to="/subject-teacher/jyoti-dabhade/dashboard">
                  Dashboard
                </Link>
              </li>
            </ul>
          ...
          <li>
            ...
            <ul className="sub-menu">
              ...
              <li>
                <Link to="/subject-teacher/jyoti-dabhade/FY-Students">First Year</Link>
              </li>
              <li>
                <Link to="/subject-teacher/jyoti-dabhade/SY-Students">Second Year</Link>
              </li>
              <li>
                <Link to="/subject-teacher/jyoti-dabhade/TY-Students">Third Year</Link>
              </li>
            </ul>
          </li>

          <li>
            <Link to="/subject-teacher/jyoti-dabhade/course">
              <i className="bx bx-book"></i>
              <span className="link_name">Course</span>
            </Link>
            <ul className="sub-menu blank">
              <li>
                <Link className="link_name" to="/subject-teacher/jyoti-dabhade/course">
                Course
                </Link>
              </li>
            </ul>
          ...
          <li>
            ...
            <ul className="sub-menu">
              ...
              <li>
                <Link to="/subject-teacher/jyoti-dabhade/profile">Profile</Link>
              </li>
            </ul>
          </li>

          <li>
            <Link to="/subject-teacher/jyoti-dabhade/leave">
              <i className="bx bxs-comment-detail"></i>
              <span className="link_name">Leaves</span>
            </Link>
            <ul className="sub-menu blank">
              <li>
                <Link className="link_name" to="/subject-teacher/jyoti-dabhade/leave">
                Leaves
                </Link>
              </li>
            </ul>
          ...
          <li>
            <div className="profile-details">
              <div className="profile-content">
                <img alt="" src={DabhadeMImg} />
              </div>
              <div className="name-job">
                <div className="profile_name">Mrs. J. G. Dabhade</div>
