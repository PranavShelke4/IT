...
import Detentionlists from '../../../../api/FirstYear/Detentionlist';
...
const Detentionlist = props => (
    <tr>
        ...
        <td>
            <Link to={"/detentionlist/FY/edit/"+props.detentionlist._id}><i className='bx bx-edit-alt'></i></Link> | <span onClick={() => {props.deleteDetentionlist(props.detentionlist._id) }} ><i className='bx bx-trash'></i></span>
    ...
    render() { 
        return ( 
            ...
            <h3 className='fidoh3'>First Year Detention Lists</h3>
                ...
                <Link to={'/class-teacher/FY/add-detentionlist'}><div className='add'>Add</div></Link>
            </div>
            </div>
         );
    }
