...
import Feedbacklists from '../../../../api/FirstYear/Feedbacklist';
...
const Feedbacklist = props => (
    <tr>
        ...
        <td>
            <Link to={"/feedbacklist/FY/edit/"+props.feedbacklist._id}><i className='bx bx-edit-alt'></i></Link> | <span onClick={() => {props.deleteFeedbacklist(props.feedbacklist._id) }} ><i className='bx bx-trash'></i></span>
...
class FeedbackList extends Component {
    ...
    render() { 
        return ( 
            ...
            <div className="fideo">
            <h3 className='fidoh3'>First Year Faculty Feedback</h3>
                ...
                <Link to={'/class-teacher/FY/add-feedbacklist'}><div className='add'>Add</div></Link>
            </div>
            </div>
         );
    }
