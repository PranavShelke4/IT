...
const Achievement = props => (
    <tr>
        ...
        <td>
            <Link to={"/CT/SY/edit/"+props.achievement._id}><i className='bx bx-edit-alt'></i></Link> | <span onClick={() => {props.deleteAchievement(props.achievement._id) }} ><i className='bx bx-trash'></i></span>
    ...
    render() { 
        return ( 
            ...
            <div className="fideo">
                ...
                <Link to='/class-teacher/SY/add-achievement'><div className='add'>Add</div></Link>
            </div>
            </div>
         );
    }
